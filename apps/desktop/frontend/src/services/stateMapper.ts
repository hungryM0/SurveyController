  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        field('random-ua-wechat', '微信访问占比', '三项访问占比合计固定为 100%', 'slider', String(uaRatios.wechat)),
        field('random-ua-mobile', '手机访问占比', '', 'slider', String(uaRatios.mobile)),
        field('random-ua-pc', '链接访问占比', '', 'slider', String(uaRatios.pc)),

...
20. Treat window adaptation as a shell-plus-page problem, not a web responsiveness problem. Use WinUI layout, VisualState, windowing, and native control behavior for wide and narrow desktop windows; do not import CSS breakpoints, phone-first assumptions, or browser viewport conventions.
...
- Never model a WinUI page as a web page. Avoid DOM/CSS vocabulary and web layout recipes when deciding XAML structure, sizing, spacing, interaction, or state ownership.
